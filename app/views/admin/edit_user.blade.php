...
@section('header')
	<title>Neoos::Foto - Edit User #{{ $user->id }}</title>
@stop
		...
		<div class="row">
			<div class="col-xs-6 col-xs-offset-3">
                <div class="box box-info">
	                ...
	                <div class="box-body">
                	{{ Form::open( ['route' => 'admin.users.update', 'method' => 'POST'] ) }}
                        ...
                        <div class="form-group">
                            <label>
                                <input type="checkbox" class="flat-green" name="active" @if( $user->active ) checked @endif />
                                 Active
                            </label>
                        </div>
